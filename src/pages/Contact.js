      ...
      <div className="container mx-auto h-full">
        <div className="flex flex-col lg:flex-row h-full items-center justify-start pt-36 gap-x-8 text-center lg:text-left">
          ...
          <div onMouseEnter={mouseEnterHandler} onMouseLeave={mouseLeaveHandler} className="lg:flex-1 lg:pt-32 px-4">
            ...
            <form className="flex flex-col gap-y-4">
              <div className="flex gap-x-10">
                <input
                  className="outline-none border-b border-primary h-[60px] bg-transparent font-secondary w-full pl-3 placeholder:text-[#757879]"
          ...
          <div
            ...
            className="lg:flex-1"
          >
            <img onMouseEnter={mouseEnterHandler} onMouseLeave={mouseLeaveHandler} src={WomanImg} alt="" />
          </div>
        </div>
      </div>
    </motion.section>
